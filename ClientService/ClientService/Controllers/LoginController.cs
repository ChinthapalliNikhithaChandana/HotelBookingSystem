       ...
       /* public IActionResult Index()
        ...
        public async Task<IActionResult> Login(User user)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                var response = await httpClient.PostAsync("http://localhost:53248/api/Auth/User", content);
                ...
                using (var response1 = await httpClient.PostAsync("http://localhost:53248/api/Auth/Login", content1))
                {
                    ...
                    return RedirectToAction("Index", "HotelList");
